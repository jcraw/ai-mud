...
- 🔄 **Starting Dungeon (Ancient Abyss)** - IN PROGRESS (6/8 chunks complete, core systems built) - See [Starting Dungeon Plan](docs/requirements/V2/FEATURE_PLAN_starting_dungeon.md)
