...
## Acceptance
- [ ] Behavior-preserving extract of `MudGameEngine.kt`, `GameServer.kt`, `MultiUserGame.kt` (pure moves / thin public entrypoints; no feature work)
...
- [ ] Retarget remaining override `ticket` from `MUD-034` → `MUD-034d` when still needed
